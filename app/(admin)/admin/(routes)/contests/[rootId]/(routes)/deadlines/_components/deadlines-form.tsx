...
export const DeadlinesFormSchema = z.object({
  deadlines: z.array(
    z.object({
...
export const DeadlinesForm = ({
  ...
  const form = useForm<z.infer<typeof DeadlinesFormSchema>>({
    mode: "all",
    resolver: zodResolver(DeadlinesFormSchema),
    values: {
      ...initialData,
  ...
  const onSubmit = async (values: z.infer<typeof DeadlinesFormSchema>) => {
